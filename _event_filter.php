        			...
        			<div class="col-lg-9 col-12 order-1 order-lg-2">
        				...
        				<div class="tab__container">
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
                                    <?php
									$sql = mysqli_query($conn, "SELECT * FROM _event WHERE e_kategori = '".$kategori."' AND e_kota = '$kota'");
		        					...
		        					<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										...
										<a class="first__img" href="_event_dtl.php?id=<?=$data['id_event']?>""><img src="function/gambar/<?php echo $data['e_gambar'];?>" alt="product image"></a>
											<a class="second__img animation1" href="_event_dtl.php?id=<?=$data['id_event']?>"><img src="assets/images/books/2.jpg" alt="product image"></a>
										</div>
